...
[!if QUERY_SINK]
	CComPtr<IWbemQuery> *m_pQuery;				// WBEM Query Parser Object
[!else]
[!if EVENT_SECURITY]
	CComPtr<IWbemQuery> *m_pQuery;				// WBEM Query Parser Object
[!endif]
...
[!if EVENT_SECURITY ]
	...
	HRESULT STDMETHODCALLTYPE AccessCheck(WBEM_CWSTR wszQueryLanguage,
											WBEM_CWSTR wszQuery,
											long lSidLength,
											const BYTE* pSid);
[!endif]
...
[!if QUERY_SINK ]
	...
	HRESULT STDMETHODCALLTYPE NewQuery(unsigned long dwId,
