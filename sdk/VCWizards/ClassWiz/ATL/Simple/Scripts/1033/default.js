...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		if (!bAttributed)
		{
			...
			RenderAddTemplate("object.rgs", strRGSFile, false, false);
		...
		// Add header
		RenderAddTemplate("object.h", strHeaderFile, selProj, true);

		// Add CPP
		RenderAddTemplate("object.cpp", strImplFile, selProj, false);
