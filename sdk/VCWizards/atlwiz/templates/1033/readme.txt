...
[!if ATTRIBUTED]
_[!output SAFE_PROJECT_NAME].idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_[!output PROJECT_NAME].h)
        GUID definitions                                (_[!output PROJECT_NAME]_i.c)
        A type library                                  (_[!output SAFE_PROJECT_NAME].tlb)
        Marshaling code                                 (_[!output PROJECT_NAME]_p.c and dlldata.c)
[!else]
[!output SAFE_PROJECT_NAME].idl
    This file contains the IDL definitions of the type library, the interfaces
    and co-classes defined in your project.
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations ([!output PROJECT_NAME].h)
        GUID definitions                                ([!output PROJECT_NAME]_i.c)
        A type library                                  ([!output SAFE_PROJECT_NAME].tlb)
        Marshaling code                                 ([!output PROJECT_NAME]_p.c and dlldata.c)

[!output PROJECT_NAME].h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in [!output SAFE_PROJECT_NAME].idl. It will be regenerated by MIDL during compilation.
[!endif]
...
[!output PROJECT_NAME]ps.vcproj
	...
	dlldata.c, [!output PROJECT_NAME]_i.c and [!output PROJECT_NAME]_p.c which are required
