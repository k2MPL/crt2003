...
// [!output CHILD_FRAME_CLASS] Erstellung/Zerstörung
...
// [!output CHILD_FRAME_CLASS] Diagnose
...
// [!output CHILD_FRAME_CLASS] Meldungshandler
[!if PROJECT_STYLE_EXPLORER]
[!if LIST_VIEW]
...
void [!output CHILD_FRAME_CLASS]::OnUpdateViewStyles(CCmdUI* pCmdUI)
{
	...
	// Wenn der rechte Bereich nicht erstellt wurde und keine Ansicht ist, werden diese Befehle deaktiviert
	if (pView == NULL)
		pCmdUI->Enable(FALSE);
	else
	{
...
void [!output CHILD_FRAME_CLASS]::OnViewStyle(UINT nCommandID)
{
	...
	// Wenn der rechte Bereich erstellt wurde und eine [!output VIEW_CLASS] ist, werden die Menübefehle verarbeitet...
	if (pView != NULL)
	{
		int nStyle = -1;
...
{
	// Senden Sie ein WM_CLOSE, um diesen Rahmen zu schließen, was mit der Auswahl
	// von "Schließen" im Systemmenü gleichzusetzen ist.
