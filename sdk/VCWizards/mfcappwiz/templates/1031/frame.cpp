...
// [!output MAIN_FRAME_CLASS] Erstellung/Zerstˆrung
...
[!endif]
[!else]
	// TODO: Lˆschen Sie diese drei Zeilen, wenn Sie nicht mˆchten, dass die Systemleiste andockbar ist
...
[!if HTML_VIEW || HTML_EDITVIEW]
	return m_wndSplitter.Create(this,
		...
		CSize(10, 10),      // TODO: Minimale Grˆﬂe des Bearbeitungsbereichs festlegen
...
BOOL [!output MAIN_FRAME_CLASS]::PreCreateWindow(CREATESTRUCT& cs)
{
	if( ![!output MAIN_FRAME_BASE_CLASS]::PreCreateWindow(cs) )
		return FALSE;
	// TODO: ƒndern Sie hier die Fensterklasse oder die Darstellung, indem Sie
...
BOOL [!output MAIN_FRAME_CLASS]::LoadFrame(UINT nIDResource, DWORD dwDefaultStyle, CWnd* pParentWnd, CCreateContext* pContext) 
{
	...
	// Die Option 'Beenden' im Dateimen¸ f¸r sekund‰re Fenster durch 'Schlieﬂen' ersetzen
	if (AfxGetApp()->m_pMainWnd != this)
	{
		CMenu *pMenu = GetMenu();
		ASSERT(pMenu);
		pMenu->ModifyMenu(ID_APP_EXIT, MF_BYCOMMAND | MF_STRING, ID_FILE_CLOSE, "&Schlieﬂen");
	}
