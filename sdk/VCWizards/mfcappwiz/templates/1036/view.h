...
[!if CONTAINER || CONTAINER_SERVER]
[!if !RICH_EDIT_VIEW]
	// m_pSelection maintient la sélection sur l'objet en cours [!output CONTAINER_ITEM_CLASS].
	// Pour de nombreuses applications, une variable membre de ce type n'est pas appropriée
	//  pour représenter une sélection, telle qu'une sélection multiple ou une sélection
	//  d'objets autres que des objets [!output CONTAINER_ITEM_CLASS]. Ce mécanisme de sélection
	//  est fourni pour vous aider à démarrer

	// TODO : remplacez ce mécanisme de sélection par un mécanisme approprié à votre application
...
#ifndef _DEBUG  // version de débogage dans [!output VIEW_IMPL]
