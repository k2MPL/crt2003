// [!output SERVER_ITEM_HEADER] : interfaccia della classe [!output SERVER_ITEM_CLASS]
//
...
protected:
	virtual void Serialize(CArchive& ar);   // sottoposto a override per l'i/o del documento
};
