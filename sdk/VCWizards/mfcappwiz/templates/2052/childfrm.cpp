// [!output CHILD_FRAME_IMPL] : [!output CHILD_FRAME_CLASS] 类的实现
//
#include "stdafx.h"
...
// [!output CHILD_FRAME_CLASS] 构造/析构
...
// [!output CHILD_FRAME_CLASS] 消息处理程序
[!if PROJECT_STYLE_EXPLORER]
[!if LIST_VIEW]
...
void [!output CHILD_FRAME_CLASS]::OnViewStyle(UINT nCommandID)
{
	...
	// 如果右窗格已创建并且是 [!output VIEW_CLASS]，则处理菜单命令...
	if (pView != NULL)
	{
		int nStyle = -1;
